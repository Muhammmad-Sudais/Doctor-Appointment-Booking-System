        ...
        <div className="hidden md:flex flex-col gap-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col leading-tight">
              ...
              <p className="text-[11px] uppercase tracking-[0.24em] text-blue-500">
                {state === "Admin" ? "Admin Panel" : "Doctor Panel"}
              </p>
            </div>
          </div>
          ...
          <div className="bg-white/80 border border-blue-50 rounded-2xl shadow-sm p-6 backdrop-blur-sm">
            ...
            <p className="text-xs text-gray-500 mb-4">
              Manage doctors, appointments, and platform settings from a single,
              secure dashboard.
            </p>
            <ul className="space-y-2 text-xs text-gray-600">
              <li className="flex items-start gap-2">
                ...
                <span>View and moderate appointment activity.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-0.5 w-4 h-4 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 text-[10px]">
                  ✓
                </span>
                <span>Manage doctor profiles and approvals.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-0.5 w-4 h-4 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 text-[10px]">
                  ✓
                </span>
                <span>Access analytics and platform configuration.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="w-full">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 max-w-md mx-auto">
            ...
            <p className="text-xs text-gray-500 mb-6">
              ...
              {state === "Admin" ? "admin" : "doctor"} dashboard.
            </p>
            ...
            <p className="mt-4 text-[11px] text-gray-500 text-center">
              ...
              <span className="text-blue-600 font-medium">admin</span> and{" "}
              <span className="text-blue-600 font-medium">doctors</span> only.
            </p>
          </div>
        </div>
      </div>
